<template>
    ...
    <nav class="py-4 text-gray-500 dark:text-gray-400">
        <!-- Logo -->
        <inertia-link :href="route('dashboard')" class="ml-6 text-lg font-bold text-gray-800 dark:text-gray-200">
            <jet-application-mark class="inline-block h-9 w-auto" />
        </inertia-link>
        ...
        <ul class="mt-6">
            ...
            <jet-nav-link :href="route('vehicles.index')" :active="route().current('vehicles.index') || route().current('vehicles.show') || route().current('vehicles.edit')">
            ...
            <jet-nav-link :href="route('drivers.index')" :active="route().current('drivers.index') || route().current('drivers.show') || route().current('drivers.edit')">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
